---
name: ghostwriter
description: Use when generating social media content, managing brand voices, working with content templates, importing source material, or calling any Ghostwriter tool. Reference for all MCP tools, input resolution modes, and multi-step workflow execution.
---

# Ghostwriter Content Generation Tools
